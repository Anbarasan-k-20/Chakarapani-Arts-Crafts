...
const AddEditProduct = () => {
  ...
  // ✅ Move fetchProduct declaration BEFORE useEffect
  ...
  const addSize = () => {
    setFormData({
      ...
      sizes: [
        ...formData.sizes,
        { dimension: "", originalPrice: "", salePrice: "" },
      ],
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (payload.sizes && payload.sizes.length > 0) {
      ...
      const lowestPrice = Math.min(
        ...payload.sizes.map((s) => Number(s.salePrice) || Infinity),
      );
                    ...
                    <div key={index} className="row g-2 align-items-end mb-2">
                      <div className="col-md-3">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleSizeChange(index, "dimension", e.target.value)
                          }
                          required
                        />
                      </div>
